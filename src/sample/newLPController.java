...
public class newLPController {
    ...
    public void add(ActionEvent event) {
        ...
        HashMap<String , Owner> map1 = od.getNameL();
        ...
        if (map.containsKey(Integer.parseInt(t3))) {
            stage = (Stage) AnchorPane4.getScene().getWindow();
            ...
            pd.addl(t1 , t2 , Integer.parseInt(t3) , own , t5 , t6 );
        }
